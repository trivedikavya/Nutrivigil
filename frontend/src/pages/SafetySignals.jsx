...
const SafetySignals = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0e1a] text-white">
            {/* Hero */}
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#1a1f2e] to-[#0a0e1a]">
                <div className="max-w-7xl mx-auto">
                    <Link to="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-colors mb-8">
                    ...
                    <div className="text-center">
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                            ...
                            <p className="text-gray-300 max-w-3xl mx-auto mb-8">Traffic Light System to help you quickly assess food safety for your health</p>
                            ...
                            <motion.div key={s.key} className="bg-[#1a1f2e]/50 p-6 rounded-2xl border border-gray-800" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: idx * 0.08 }}>
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300">{s.meaning}</p>
                                    </div>
                                </div>

                                <div className="mt-3">
                                    <p className="text-sm text-gray-300 font-semibold mb-2">Example Foods</p>
                                    ...
                                    <p className="text-sm text-gray-400"><strong>Portion guidance:</strong> Follow moderation and check portion sizes for yellow items; avoid frequent red items.</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                        ...
                        <motion.div className="bg-[#1a1f2e] p-4 rounded-2xl border border-gray-800" initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">Signal: <span className="text-green-400 font-semibold">Green</span></p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div className="bg-[#1a1f2e] p-4 rounded-2xl border border-gray-800" initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">Signal: <span className="text-yellow-300 font-semibold">Yellow</span></p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div className="bg-[#1a1f2e] p-4 rounded-2xl border border-gray-800" initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">Signal: <span className="text-red-400 font-semibold">Red</span></p>
                                </div>
                            </div>
                        </motion.div>
            ...
            {/* CTA */}
            <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/30 to-pink-900/30">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">Try the Safety Scanner</h2>
                    <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Scan your food to see instant safety signals tailored for you.</p>
